...
async function startBot() {
    ...
    sock.ev.on('messages.upsert', async m => {
        ...
        // 3. Default reply if no match found
        await sock.sendMessage(from, {
            text: `🤖 Hi! I'm the *Digita Marketing* Assistant.\n\nType *menu* to see our services, or reply with a service name for full details and pricing!\n\n📞 +91 9305243187\n🌐 www.digitamarketing.in`
        });
    });
}
